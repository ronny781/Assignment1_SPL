...
link:
	g++ -o bin/studio bin/main.o bin/Student.o bin/Trainer.o bin/workout.o bin/Action.o bin/Customer.o config


compile:
	g++ -g -Wall --std=c++11 -Weffc++ -c -o bin/main.o src/main.cpp
	g++ -g -Wall --std=c++11 -Weffc++ -c -o bin/Studet.o src/Studet.cpp
